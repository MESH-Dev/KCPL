    ...
    <form method="get" id="searchForm" action="http://kana.ent.sirsi.net/client/embedded.search/http://kana.ent.sirsi.net/client/default">
      ...
      <div id="search-params">
        ...
        <div id="select" class="<?php if($active =='media') echo 'media-active'; else echo 'audience-active'?> clearfix">
          <div class="media">
            <div class="search-btn first books <?php if($thisID == 119) echo 'active'; else echo 'inactive'; ?>  ">
              <div class="iconCont">
            ...
            <div class="search-btn music <?php if($thisID == 120) echo 'active'; else echo 'inactive'; ?>">
              <div class="iconCont">
            ...
            <div class="search-btn research <?php if($thisID == 126) echo 'active'; else echo 'inactive'; ?>">
              <div class="iconCont">
            ...
            <div class="search-btn magazines <?php if($thisID == 123) echo 'active'; else echo 'inactive'; ?>">
              <div class="iconCont">
            ...
            <div class="search-btn video <?php if($thisID == 124) echo 'active'; else echo 'inactive'; ?>">
              <div class="iconCont">
            ...
            <div class="search-btn ebooks <?php if($thisID == 121) echo 'active'; else echo 'inactive'; ?>">
              <div class="iconCont">
            ...
            <div class="search-btn audiobooks <?php if($thisID == 122) echo 'active'; else echo 'inactive'; ?>">
              <div class="iconCont">
            ...
            <div class="search-btn last download <?php if($thisID == 125) echo 'active'; else echo 'inactive'; ?>">
              <div class="iconCont">
          ...
          <div class="audience">
            <div class="search-btn first kids <?php if($thisID == 128) echo 'active'; else echo 'inactive'; ?>">
              <div class="iconCont">
            ...
            <div class="search-btn teens <?php if($thisID == 127) echo 'active'; else echo 'inactive'; ?>">
              <div class="iconCont">
            ...
            <div class="search-btn last adults <?php if($thisID == 423) echo 'active'; else echo 'inactive'; ?>">
              <div class="iconCont">
